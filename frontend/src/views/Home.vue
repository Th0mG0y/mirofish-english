  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">Simple General-Purpose Collective Intelligence Engine</span>
            <span class="version-text">/ v0.1-Preview</span>
          </div>
          
          <h1 class="main-title">
            Upload Any Report<br>
            <span class="gradient-text">Simulate the Future Now</span>
          </h1>
          
          <div class="hero-desc">
            <p>
              Even with just a single paragraph, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world composed of up to <span class=”highlight-orange”>millions of Agents</span> based on the seeds of reality within. Inject variables from a god's-eye view to find the <span class=”highlight-code”>”local optimum”</span> in dynamic environments through complex collective interactions.
            </p>
            <p class=”slogan-text”>
              Let the future be rehearsed among Agents, let decisions prevail after a hundred battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to million-scale Agent simulation</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsed prediction requirements & dynamic temporal memory update</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">Drag and drop to upload</div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. If a major tech company announces mass layoffs of 10,000 employees, what public reaction trends would emerge across social media)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to Process page (use special identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Use Space Grotesk as the primary title font, JetBrains Mono as the code/label font.

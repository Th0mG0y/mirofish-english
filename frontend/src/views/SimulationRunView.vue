...
// Get maxRounds from query parameter at initialization time so child components have the value immediately
...
const handleNextStep = () => {
  ...
  // This method is for backup use only
...
const loadGraph = async (graphId) => {
  // When simulating, auto-refresh won't show full-screen loading to avoid flicker
...
onMounted(() => {
  ...
  // Log maxRounds config (value already obtained from query parameter at init)
  if (maxRounds.value) {

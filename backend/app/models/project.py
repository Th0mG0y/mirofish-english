...
Used to persist project state on the server side, avoiding large data transfers between interfaces on the frontend
"""
...
class Project:
    ...
    # Ontology information (populated after interface 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (populated after interface 2 completion)
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the project extracted text storage path"""

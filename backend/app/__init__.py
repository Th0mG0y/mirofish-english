...
def create_app(config_class=Config):
    ...
    # Configure JSON encoding: ensure non-ASCII characters are displayed directly (not as \uXXXX)
    ...
    # Register blueprints
    from .api import graph_bp, simulation_bp, report_bp, search_bp, deliberation_bp
    app.register_blueprint(graph_bp, url_prefix='/api/graph')
    app.register_blueprint(simulation_bp, url_prefix='/api/simulation')
    app.register_blueprint(report_bp, url_prefix='/api/report')
    app.register_blueprint(search_bp, url_prefix='/api/search')
    app.register_blueprint(deliberation_bp, url_prefix='/api/deliberation')

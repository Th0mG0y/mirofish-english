...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified status dictionary (for API responses)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No entities matching the criteria were found, please check if the graph was built correctly"
                self._save_simulation_state(state)
                return state
            ...
            # Note: Run scripts are kept in the backend/scripts/ directory and are no longer copied to the simulation directory

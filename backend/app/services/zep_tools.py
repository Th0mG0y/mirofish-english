...
class EdgeInfo:
    ...
    def is_invalid(self) -> bool:
        """Whether this edge has become invalid"""
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries and a synthesized analysis
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"Research scenario: {self.simulation_requirement}",
            f"\n### Research Data Statistics",
            f"- Relevant research facts: {self.total_facts}",
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            f"## Broad Search Results (Full Research Panorama)",
            f"Query: {self.query}",
            f"\n### Statistics",
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out junk content with question numbers (questions 1-9)
                skip = False
                for d in '123456789':
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        """Convert to detailed text format for LLM consumption and report citations"""
        text_parts = [
...
class ZepToolsService:
    ...
    4. interview_agents - deep interview (interviews simulated Agents, collects multi-perspective views)
    ...
    def _local_search(
        ...
        Retrieves all edges/nodes and performs local keyword matching
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Retrieves all graph edges and filters for those related to the specified node
    ...
    def get_entities_by_type(
        ...
        filtered = []
        for node in all_nodes:
            # Check if labels contains the specified type
    ...
    def get_simulation_context(
        ...
        Searches comprehensively for all information related to simulation requirements
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function, auto-decomposes questions and retrieves across multiple dimensions:
        ...
        # Get details for all related entities (no count limit, complete output)
        entity_insights = []
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        Gets a full panoramic view, including all related content and historical/expired information:
        ...
        This tool is suitable for scenarios that require understanding the full picture of events or tracking evolution.
    ...
    def interview_agents(
        ...
        [Use cases]
        - Need to understand perspectives on events from different roles
        ...
        INTERVIEW_PROMPT_PREFIX = (
            "You are being interviewed. Please draw upon your persona, all past memories and actions, "
            "and respond directly to the following questions in plain text.\n"
        ...
        # Step 4: Call the real interview API (no platform specified, default to both platforms simultaneously)
        try:
            # Build batch interview list (no platform specified, interview on both platforms)
            interviews_request = []
            ...
            # Call SimulationRunner batch interview method (no platform specified, both platforms)
            api_result = SimulationRunner.interview_agents_batch(
                simulation_id=simulation_id,
                interviews=interviews_request,
                platform=None,  # No platform specified, both platforms
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Long text inside correctly paired Chinese quotation marks 「」
                if not key_quotes:
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                - selected_agents: Complete information list for selected Agents
...
3. Select diverse viewpoints (e.g. supporters, opponents, neutral parties, experts, etc.)
...
List of available Agents ({len(agent_summaries)} total):
{json.dumps(agent_summaries, ensure_ascii=False, indent=2)}

Please select up to {max_agents} Agents most suitable for interview, and explain the selection rationale."""
...
1. Distill the main views from each party
2. Point out areas of consensus and disagreement

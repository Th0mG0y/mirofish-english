...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: Interview both platforms in dual-platform mode; interview the available platform in single-platform mode
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional; overridden by individual interview platform)
                - "twitter": Default to Twitter platform only
                - "reddit": Default to Reddit platform only
                - None: Interview both platforms per agent in dual-platform mode
            timeout: Timeout in seconds
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        ...
        # Retrieve command files sorted by modification time
        command_files = []

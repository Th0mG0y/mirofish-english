...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return in "agent_name: activity_description" format without a simulation prefix
    ...
    def _describe_like_post(self) -> str:
        """Like a post - includes the post content and author info"""
    ...
    def _describe_dislike_post(self) -> str:
        """Dislike a post - includes the post content and author info"""
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
    ...
    def _describe_repost(self) -> str:
        """Repost - includes the original post content and author info"""
...
class ZepGraphMemoryUpdater:
    ...
    # Batch size (number of activities per platform before sending)
    BATCH_SIZE = 5
    ...
    # Send interval in seconds (to avoid sending too fast)
    SEND_INTERVAL = 0.5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context (e.g. post text, user names).
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "items_sent": self._total_items_sent,        # Successfully sent activity item count
            "failed_count": self._failed_count,          # Failed batch count
            "skipped_count": self._skipped_count,        # Skipped activity count (DO_NOTHING)
...
class ZepGraphMemoryManager:
    ...
    def create_updater(cls, simulation_id: str, graph_id: str) -> ZepGraphMemoryUpdater:
        ...
        """
        with cls._lock:
            # Stop the existing updater if one already exists

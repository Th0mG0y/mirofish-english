"""
Report API routes
Provides interfaces for simulation report generation, retrieval, conversation, etc.
"""
    ...
    try:
        ...
        def run_generate():
            try:
                ...
                # Generate report (passing the pre-generated report_id)
...
# ============== Report Agent Conversation Interface ==============
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this interface to get generated section content without waiting for the entire report to complete
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is only unlocked after report is completed
...
def get_agent_log(report_id: str):
    ...
    Real-time retrieval of every step during report generation, including:
    - Report start, outline planning start/completion
    - Start, tool calls, LLM responses, completion for each section
...
def get_console_log(report_id: str):
    ...
    Real-time retrieval of console output (INFO, WARNING, etc.) during report generation,
    this differs from the structured JSON logs returned by the agent-log interface,
    it is pure text format console-style logs.
